...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TBRawEvent*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TBRawEvent*>", -2, "vector", 447,
...
"/Users/gold/baconLocal/git/bacon/baconData/bobj/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("TBRawRun_Dict",
        ...
        TriggerDictionaryInitialization_TBRawRun_Dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
